...
export default function CalendarComponent() {
  ...
  return (
    <div className=" absolute top-[4.25rem] z-50 right-0 w-86 h-[calc(100vh-4.25rem)]">
      <Calendar
        mode="single"
        defaultMonth={date}
        selected={date}
        onSelect={setDate}
        className="rounded-lg border shadow-sm w-full bg-foreground h-full  [&_.rdp-day]:h-22"
        classNames={{
          root: cn("flex flex-col h-full ", defaultClassNames.root),

          months: cn(
            "flex p-0 flex-col items-center",
          ...
          cell: "p-0 w-[2.5rem] h-[2.5rem] flex items-center justify-center",
